...
namespace NAL_SMTA
{
    class ConnectDB
    {
        ...
        public string[] InMAIN_INS_STBL(string PROCESS, string BARCODE, string LOT, string ShiftID, string Shift, string Emp, string Seiban, string CLIENT, string Type, string Cover)
        {
            ...
            try
            {
                ...
                using (cnn)
                {
                    ...
                    objCmd.Parameters.Add(new SqlParameter("@pMold", ""));
                    objCmd.Parameters.Add(new SqlParameter("@pSensorR", ""));
                    objCmd.Parameters.Add(new SqlParameter("@pSensorL", ""));
        ...
        public string[] GetMakerLot(string Batch)
        {
            try
            {
                ...
                using (cnn)
                {
                    strStored = "[STBL_SAP_DATA].[dbo].[STBL_GET_MARKER_LOT]";
                    objCmd.Parameters.Add(new SqlParameter("@pBatch", Batch));
                    ...
                    try
                    {
                        string[] WR;
                        string pMaterial_No;
                        string pMaterial_Description;
                        string pMaker_Lotno2;
                        string pMaker_Lotno3;

                        if (dt.Rows.Count > 0)
                        {
                            pMaterial_No = dt.Rows[0]["Material_No"].ToString();
                            pMaterial_Description = dt.Rows[0]["MatDESC"].ToString();
                            pMaker_Lotno2 = dt.Rows[0]["MakerLot"].ToString();
                            pMaker_Lotno3 = dt.Rows[0]["Maker_Lotno3"].ToString();
                        }
                        else
                        {
                            pMaterial_No = "";
                            pMaterial_Description = "";
                            pMaker_Lotno2 = "";
                            pMaker_Lotno3 = "";
                        }

                        WR = new string[] { pMaterial_No, pMaterial_Description, pMaker_Lotno2, pMaker_Lotno3 };
        ...
        public string[] STBL_IND_MAKERLOT(string Process, string Serial, string ItemCD, string ItemDESC, string Batch, string MakerLot, string Emp, string CLIENT, string Shift)
        {
            try
            {
                SqlConnection cnn = ConnectionDB();
                ...
                using (cnn)
                {
                    strStored = "STBL_IND_MAKERLOT";
                    objCmd.Parameters.Add(new SqlParameter("@pProcess", Process));
                    objCmd.Parameters.Add(new SqlParameter("@pSerial", Serial));
                    objCmd.Parameters.Add(new SqlParameter("@pItemCD", ItemCD));
                    objCmd.Parameters.Add(new SqlParameter("@pItemDESC", ItemDESC));
                    objCmd.Parameters.Add(new SqlParameter("@pBatch", Batch));
                    objCmd.Parameters.Add(new SqlParameter("@pMakerLot", MakerLot));
                    objCmd.Parameters.Add(new SqlParameter("@pEmp", Emp));
                    objCmd.Parameters.Add(new SqlParameter("@pClient", CLIENT));
                    objCmd.Parameters.Add(new SqlParameter("@pSHIFT", Shift));
        ...
        public string PSES_CHK_MAKER_ITEM(string Process, string ItemCode)
        {
            string Result;
            try
            {
                ...
                using (cnn)
                {
                    strStored = "[STBL_PSES].[dbo].[PSES_CHK_MAKER_ITEM]";
                    objCmd.Parameters.Add(new SqlParameter("@pItemCode", ItemCode));
                    objCmd.Parameters.Add(new SqlParameter("@pProcess", Process));
